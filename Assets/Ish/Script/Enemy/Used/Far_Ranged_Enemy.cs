...
public class Far_Ranged_Enemy : Enemy_BaseClass
{
    ...
    {       
        ...
        SetUpEnemy(player2, transform.rotation, transform.position, 10, 10, 10, 10, 10, 10, 10, 10, 16,AttackRangeInt, 'R', true); //The first function needed to set up the enemy
